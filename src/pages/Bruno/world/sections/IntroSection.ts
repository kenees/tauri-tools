...
export default class IntroSection {
  ...
  constructor(_options: { config: any; time: any; resources: any; objects: any; areas: any; walls: any; tiles: any; debug: any; x: any; y: any }) {
    // Options
  ...
  setInstructions() {
    ...
    if (!this.config.touch) {
      ...
      console.log(this.instructions.arrows);
    }
  }
