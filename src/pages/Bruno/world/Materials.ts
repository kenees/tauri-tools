...
import FloorShadowMaterial from "../materials/FloorShadow.ts";
import MatcapMaterial from "../materials/Matcap.ts";
...
export default class Materials {
  ...
  constructor(_options: { resources: any; debug: any }) {
    // Options
  ...
  setShades() {
    ...
    // White
    this.shades.items.white = MatcapMaterial();
    ...
    // Orange
    this.shades.items.orange = MatcapMaterial();
    ...
    // Green
    this.shades.items.green = MatcapMaterial();
    ...
    // Brown
    this.shades.items.brown = MatcapMaterial();
    ...
    // Gray
    this.shades.items.gray = MatcapMaterial();
    ...
    // Beige
    this.shades.items.beige = MatcapMaterial();
    ...
    // Red
    this.shades.items.red = MatcapMaterial();
    ...
    // Black
    this.shades.items.black = MatcapMaterial();
    ...
    // Green emerald
    this.shades.items.emeraldGreen = MatcapMaterial();
    ...
    // Purple
    this.shades.items.purple = MatcapMaterial();
    ...
    // Blue
    this.shades.items.blue = MatcapMaterial();
    ...
    // Yellow
    this.shades.items.yellow = MatcapMaterial();
    ...
    // Metal
    this.shades.items.metal = MatcapMaterial();
  ...
  setFloorShadow() {
    this.items.floorShadow = FloorShadowMaterial();
