// import mobileDoubleTriangle from "./bruno/images/mobile/doubleTriangle.png";
...
export default class Controls extends EventEmitter {
  ...
  keyboard: any;
  touch: any;
  constructor(_options: { config: any; sizes: any; time: any; camera: any; sounds: any }) {
    super();
  ...
  setKeyboard() {
    ...
    this.keyboard.events.keyDown = (_event: any) => {
      switch (_event.code) {
        case "ArrowUp":
        case "KeyW":
    ...
    this.keyboard.events.keyUp = (_event: any) => {
      switch (_event.code) {
        case "ArrowUp":
        case "KeyW":
          this.actions.up = false;
  ...
  setTouch() {
    ...
    this.time.on("tick", () => {
      ...
      if (this.touch.joystick.active) {
        ...
        this.touch.joystick.angle.originalValue = -Math.atan2(this.touch.joystick.angle.current.y - this.touch.joystick.angle.center.y, this.touch.joystick.angle.current.x - this.touch.joystick.angle.center.x);
    ...
    this.touch.joystick.events.touchstart = (_event: any) => {
    ...
    this.touch.joystick.events.touchmove = (_event: any) => {
      _event.preventDefault();
    ...
    this.touch.joystick.events.touchend = (_event: any) => {
      const touches = [..._event.changedTouches];
      const touch = touches.find((_touch) => _touch.identifier === this.touch.joystick.touchIdentifier);
    ...
    this.touch.boost.events.touchstart = (_event: any) => {
      _event.preventDefault();
    ...
    this.touch.boost.events.touchend = (_event: any) => {
      const touches = [..._event.changedTouches];
    ...
    this.touch.forward.events.touchstart = (_event: any) => {
      _event.preventDefault();
    ...
    this.touch.forward.events.touchend = (_event: any) => {
      const touches = [..._event.changedTouches];
    ...
    this.touch.brake.events.touchstart = (_event: any) => {
      _event.preventDefault();
    ...
    this.touch.brake.events.touchend = (_event: any) => {
      const touches = [..._event.changedTouches];
    ...
    this.touch.backward.events.touchstart = (_event: any) => {
      _event.preventDefault();
    ...
    this.touch.backward.events.touchend = (_event: any) => {
      const touches = [..._event.changedTouches];
