...
import ShadowMaterial from "../materials/Shadow.ts";
...
export default class Shadows {
  ...
  constructor(_options: { time: any; debug: any; renderer: any; camera: any }) {
    // Options
  ...
  setMaterials() {
    ...
    // Base
    this.materials.base = ShadowMaterial();
  ...
  setHelper() {
    ...
    this.helper.transformControls.addEventListener("dragging-changed", (_event: any) => {
